...
- **Marker terminology reconciled across the repo** — The canonical name and path of the durable artifact are **marker** at `.workstream/workstream.json` (R10, KTD2, KTD4, KTD13, U1, and the 2026-08-04 terminology decision). CONCEPTS.md had drifted to "workstream manifest" at `.workstream/manifest.json` during the 2026-08-04 rename; CONCEPTS.md now follows the plan. This plan and its contracts are authoritative; do not reopen the name or path.
