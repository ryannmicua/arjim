...
Scope is workstream registration only: machine scan of workspaces and registry consumption are designed but deferred and not functional in this version; every command operates on explicit operator-supplied paths only.
